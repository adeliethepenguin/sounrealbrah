...
#include "MoreFunWithBallz/Classes/CameraDirector.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeCameraDirector() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	MOREFUNWITHBALLZ_API UClass* Z_Construct_UClass_ACameraDirector();
	MOREFUNWITHBALLZ_API UClass* Z_Construct_UClass_ACameraDirector_NoRegister();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACameraDirector_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Classes/CameraDirector.h" },
	};
#endif
#if WITH_METADATA
	...
	template<> MOREFUNWITHBALLZ_API UClass* StaticClass<ACameraDirector>()
	{
		return ACameraDirector::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ACameraDirector);
	ACameraDirector::~ACameraDirector() {}
	struct Z_CompiledInDeferFile_FID__more__Projects_sounrealbrah_MoreFunWithBallz_Source_MoreFunWithBallz_Classes_CameraDirector_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID__more__Projects_sounrealbrah_MoreFunWithBallz_Source_MoreFunWithBallz_Classes_CameraDirector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACameraDirector, ACameraDirector::StaticClass, TEXT("ACameraDirector"), &Z_Registration_Info_UClass_ACameraDirector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACameraDirector), 246429353U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID__more__Projects_sounrealbrah_MoreFunWithBallz_Source_MoreFunWithBallz_Classes_CameraDirector_h_2959798060(TEXT("/Script/MoreFunWithBallz"),
		Z_CompiledInDeferFile_FID__more__Projects_sounrealbrah_MoreFunWithBallz_Source_MoreFunWithBallz_Classes_CameraDirector_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID__more__Projects_sounrealbrah_MoreFunWithBallz_Source_MoreFunWithBallz_Classes_CameraDirector_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
